...
def encode_prompts_flux2(
    ...
    pe = Flux2Pipeline._get_mistral_3_small_prompt_embeds(
        text_encoder,
        tokenizer,
        prompts,
        dtype=dtype,
    ...
    text_ids = Flux2Pipeline._prepare_text_ids(pe)
    return pe.to(device=device, dtype=dtype), text_ids.to(device=device, dtype=dtype)
